...
private:
	...
	bool blockedNodes(const Path& path,
	...
	void generalizedRectangle(const Path& path1, const Path& path2, const MDD& mdd1, const MDD& mdd2,
	...
	int classifyRectangleConflict(const pair<int, int>& s1, const pair<int, int>& s2, const pair<int, int>& g1, const pair<int, int>& g2,
